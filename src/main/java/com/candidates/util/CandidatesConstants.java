...
public class CandidatesConstants {
	...
	public static final String GET_NOTIFICATION_200_RESPONSE = "Work experiences retrieved";
	...
	public static final String GET_CONDITIONS_NOT_FOUND = "No records found";
